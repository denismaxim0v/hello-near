...
var CONTRACT_NAME = 'hello-world.denismaxim0v.testnet';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/hack-lenovo-04", "/.near/validator_key.json"),
...
document.querySelector("input#hello_world").oninput = function (event) {
...
function _fetchGreeting() {
  _fetchGreeting = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
var hello_world_button = document.querySelector("button#hello_world");

hello_world_button.onclick = function () {
  hello_world_button.innerHTML = '<span class="spinner-border spinner-border-sm mr-2" role="status" aria-hidden="true" style="margin-right: 5px"></span>Sending...';
  hello_world_button.disabled = true;
  window.contract.get_answer({
    name: document.querySelector("input#hello_world").value
